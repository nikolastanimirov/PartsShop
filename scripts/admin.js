function myFunction() {
  ...
  input = document.getElementById("searchValue-admin");
  filter = input.value.toUpperCase();
  ul = document.getElementById("products-list-admin");
...
//Pagination
const taskList = document.querySelector("#products-list-admin");
...
let arrayList = document
  .getElementById("search-products-admin")
  .querySelectorAll("li");
